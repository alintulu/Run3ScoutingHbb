...
void draw_PFratio_QCDMC(){
  ...
  for(int j=0; j<procs.size(); j++){
	...
	/*
	  TH1D* h_pass = (TH1D*)data_pass->createHistogram("data_pass",*w->var("reg"));
	  TH1D* h_fail = (TH1D*)data_fail->createHistogram("data_fail",*w->var("reg"));
