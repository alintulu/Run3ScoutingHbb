...
from processors import DDTCheckProcessor
...
for this_file in infiles:
    ...
    outfile = f'outfiles/Run3Summer22EE/ddt_check/dask_{index}.coffea'
    ...
    output = processor.run_uproot_job(
                this_file,
                "Events",
                processor_instance=DDTCheckProcessor(mass="particleNet_mass"),
