...
infiles = subprocess.getoutput("ls data/inputfiles/Run3Summer22EE/*.json").split()

for this_file in infiles:

    index = this_file.split("/")[-1].split(".json")[0]
    outfile = f'outfiles/Run3Summer22EE/hist/dask_{index}.coffea'
    ...
    output = processor.run_uproot_job(
                this_file,
                "Events",
                processor_instance=HistProcessor(jet_arbitration='ddb', systematics=True, mass="particleNet_mass"),
